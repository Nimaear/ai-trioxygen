...
import { Baseline, ChevronDown, ChevronsUpDown, Compass, Layout, LayoutTemplate, MousePointerClick, Palette, PanelTop, Phone, Search, SlidersHorizontal, Type } from 'lucide-react'
...
const COMPONENTS = [
  ...
  { to: '/phone-number-input', label: 'Phone Number Input', icon: <Phone size={14} /> },
