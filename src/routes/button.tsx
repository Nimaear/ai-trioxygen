  ...
  return (
    <ShowcasePage>
      <ShowcaseHero name="Button">
        Headless compound component — compose icons, labels, and other elements freely.
        Three variants, three sizes, full keyboard and screen-reader support via React Aria.
      </ShowcaseHero>
        ...
        <ShowcaseMatrix rows={VARIANTS} cols={SIZES}>
          {(variant, size) => (
            <Button variant={variant} size={size}>
              <Button.Icon><Save size={ICON_SIZE[size]} /></Button.Icon>
      ...
      <ShowcaseSection label="Composition">
        <ShowcaseRow>
          ...
          <Button variant="secondary">
            ...
            <Button.Icon><ArrowRight size={16} /></Button.Icon>
          </Button>
      ...
      <ShowcaseSection label="States">
        <ShowcasePanel>
          ...
          <Button variant="secondary" isDisabled><Button.Label>Disabled</Button.Label></Button>
          <Button variant="ghost"><Button.Label>Ghost</Button.Label></Button>
          <Button variant="ghost" isDisabled><Button.Label>Disabled</Button.Label></Button>
        </ShowcasePanel>
      </ShowcaseSection>
